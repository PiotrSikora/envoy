...
#define _DEFINE_GET_GLOBAL(_T)                                                                     \
  virtual std::unique_ptr<Global<_T>> getGlobal(absl::string_view) { return nullptr; }
  FOR_ALL_WASM_VM_GLOBALS(_DEFINE_GET_GLOBAL)
#undef _DEFINE_GET_GLOBAL
